...
<div class="kataggelies-filter">
    ...
    <div class="left filter-ddl">
		...
		<input class="searchinput" type="text" id="carrier" value="Υπηρεσία / Οργανισμός" onclick="ClearTxt(this,'Υπηρεσία / Οργανισμός')" onblur="ResetTxt(this,'Υπηρεσία / Οργανισμός')"/></div>
    <div class="left filter-btn"><img onmouseover="this.src='images/btns/searchon.png'" onmouseout="this.src='images/btns/search.png'"  src="images/btns/search.png" onclick="$('#rpt').empty();pageno = 0;BindGrid(false);"/></div>
    <div class="clear"></div>
</div>
<div class="content">
