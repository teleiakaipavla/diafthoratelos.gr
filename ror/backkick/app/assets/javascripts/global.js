$(document).ready(function () {
    ...
    $('.social .fb img').mouseover(function () {
        $(this).attr("src", "Global/facebookon.png")
    });
    $('.social .fb img').mouseout(function () {
        $(this).attr("src", "Global/facebook.png")
    });

    $('.social .tw img').mouseover(function () {
        $(this).attr("src", "Global/twitteron.png")
    });
    $('.social .tw img').mouseout(function () {
        $(this).attr("src", "Global/twitter.png")
    });

    $('.social .mail img').mouseover(function () {
        $(this).attr("src", "Global/mailon.png")
    });
    $('.social .mail img').mouseout(function () {
        $(this).attr("src", "Global/mail.png")
    });
